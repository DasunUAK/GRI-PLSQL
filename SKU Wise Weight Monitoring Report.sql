...
WHERE t.eff_phase_out_date is null AND s.contract = 'GRI01' AND t.bom_type_db = 'M' AND q.BOM_TYPE_DB = 'M' AND r.contract = 'GRI01' AND
r.accounting_group LIKE '&SITE'
...
AND t.eff_phase_in_date Between to_date( '&From_Date', 'DD-MM-YYYY' ) 
