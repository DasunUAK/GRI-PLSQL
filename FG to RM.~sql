...
(
select t.order_no ON19,t.part_no P20,q.part_no P21,r.lot_batch_no LOT11,s.part_product_family PPF9,u.source_ref1 ON20 from Shop_Ord t
inner join SHOP_MATERIAL_ALLOC q on t.order_no = q.order_no
Inner Join Inventory_Transaction_Hist2 r on q.order_no= r.source_ref1 and q.part_no = r.part_no and r.transaction_code in ('BACFLUSH','SOISS')
inner join Inventory_part s on r.part_no = s.part_no
Left join Inventory_Transaction_Hist2 u on r.part_no = u.part_no and r.lot_batch_no = u.lot_batch_no and u.transaction_code = 'OOREC'

Group by t.order_no,t.part_no,q.part_no,r.lot_batch_no,s.part_product_family,u.source_ref1)T11 ON T10.ON18 = T11.ON19


WHERE T0.ON1 = '191685' and (T3.PPF1 = 'RRB' OR T4.PPF2 = 'RRB' OR T5.PPF3 = 'RRB' OR T6.PPF4 = 'RRB' OR T7.PPF5 = 'RRB'
OR T8.PPF6 = 'RRB' OR T9.PPF7 = 'RRB' OR T10.PPF8 = 'RRB' OR T11.PPF9 = 'RRB')
